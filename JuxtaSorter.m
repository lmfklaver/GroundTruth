...
for iSess = 1:length(sessions)
    selecSession = sessions{iSess};
        if strcmp(areas{iSess},'hpc')
        basepath = fullfile('E:\Data\GroundTruth\',selecSession);%'m52_190731_145204_cell3';
        cd(basepath)
        ...
        [juxtaSpikes, allJuxtas] = GetJuxtaSpikes(basepath, selecSession, ops, params);
